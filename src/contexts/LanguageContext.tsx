...
export const translations = {
  ...
  chart_7d_badge: { vi: '7 NGÀY', en: '7 DAYS' },
  chart_1m_badge: { vi: '1 THÁNG', en: '1 MONTH' },
  chart_range_1d: { vi: '1N', en: '1D' },
  chart_range_7d: { vi: '7N', en: '7D' },
  chart_range_1m: { vi: '1TH', en: '1M' },
  chart_my_share: { vi: 'CỦA TÔI', en: 'MY SHARE' },
  chart_pool_share: { vi: 'POOL ($50k)', en: 'POOL ($50k)' },
  chart_today: { vi: 'Hôm nay', en: 'Today' },
  chart_7d: { vi: '7 ngày', en: '7D' },
  chart_1m: { vi: '1 tháng', en: '1M' },
